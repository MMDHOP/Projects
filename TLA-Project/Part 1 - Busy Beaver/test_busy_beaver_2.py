...
bbeaver2 = TuringMachine(
    { 
        # Part III c) - Write your transition rules for the 2-card Busy Beaver program here
        ('a', '0'): ('b', '1', 'R'), ('a', '1'): ('b', '1', 'L'),
        ('b', '0'): ('a', '1', 'L'), ('b', '1'): ('h', '1', 'R')
    },
...
bbeaver3 = TuringMachine(
    {
        # Part III e) - Write your own transition rules for the 3-card Busy Beaver program here
        ('a', '0'): ('b', '1', 'R'), ('a', '1'): ('h', '1', 'R'),
        ('b', '0'): ('c', '0', 'R'), ('b', '1'): ('b', '1', 'R'),
        ('c', '0'): ('c', '1', 'L'), ('c', '1'): ('a', '1', 'L')
    },
